...
// Initalizing arrays with initializer lists.
function start()
{
	// Initializer list soecifies the number of elements and
	// a value for each element.
	var color = new Array( "cyan", "magenta","yellow","black" );
...
function outputArray( heading, theArray, output )
{
	var content = "<h2>" + heading + "</h2><table>" +
	   "<thead><th><Index<?th><th>Value</th><th></thead><tbody>";
