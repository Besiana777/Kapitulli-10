//Fig. 10.4: IntiArray.js
//Create two arrays, intialize their elements and display them
function start()
{
	var n1 = new Array( 5 ); // allocate five-element array
	var n2 = new Array(); // allocate empty array

	// asign values to each element of array n1
	...
	// create and intiliaze five elements in array n2
	for ( i = 0; i < 5; ++1 )
	{
		n2[ i ] = i;
	} // end for

	outputArray( "Array n1:", n1, document.getElementyById( "output1" ) );
	outputArray( "Array n1:", n2, document.getElementyById( "output2" ) );
}  // end function start
...
// output the index the value of each array element
